...
//                     {
//                         AudioUtility.PlayClip(allBgm[i].clip);
//                     }
//                     else
//                     {
//                         AudioUtility.StopClip(allBgm[i].clip);
//                     }
//                     allBgm[i].editorPlaying = !allBgm[i].editorPlaying;

//                 }
//                 if (allBgm[i].editorPlaying && !AudioUtility.IsClipPlaying(allBgm[i].clip))
//                 {
...
//                     {
//                         AudioUtility.PlayClip(allSfx[i].clip);
//                     }
//                     else
//                     {
//                         AudioUtility.StopClip(allSfx[i].clip);
//                     }
//                     allSfx[i].editorPlaying = !allSfx[i].editorPlaying;

//                 }
//                 if (allSfx[i].editorPlaying && !AudioUtility.IsClipPlaying(allSfx[i].clip))
//                 {
...
//         void OpenXml()
//         {
//             string ppp = "Assets/Art/Config/AudioConfig.asset";

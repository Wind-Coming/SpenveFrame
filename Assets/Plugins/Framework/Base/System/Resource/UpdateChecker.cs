...
public class UpdateChecker : MonoBehaviour 
{
    ...
    {
        string url = Path.Combine(Utils.GetExternalPath(true, false), "updateConfig.xml"); 
        ...
        if (File.Exists(url))
        {
            ...
            string innerPath = Path.Combine(Utils.GetInnerPath(), "updateConfig.xml");
            print(innerPath);
    ...
    public void UpdateLocalVersion( string name )
    {
       ...
       if(server == null){
        ...
        localConfig.Save(Path.Combine(Utils.GetExternalPath(true, false), "updateConfig.xml"));
    }

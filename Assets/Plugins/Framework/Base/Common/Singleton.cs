...
public abstract class SingleInstance<T> where T : new()
{
    ...
    public static void Destroy(GameObject fx)
    {
        mInstance = default(T);
    }
}
...
/// <summary>
/// 没有的话自动创建，且不会随场景的销毁而销毁
/// </summary>
/// <typeparam name="T"></typeparam>
public class SingletonCreateDontDestroy<T> : MonoBehaviour where T : SingletonCreateDontDestroy<T>
{

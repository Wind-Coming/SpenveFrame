...
namespace FairyGUI
{
    ...
    public class GGraph : GObject, IColorGear
    {
        ...
        override protected void CreateDisplayObject()
        {
            ...
            displayObject.onAddedToStage.Add( ShowParticle );
        }
        ...
        private GameObject _customParticle;
        ...
        protected void ShowParticle()
        {
            ...
            if (!string.IsNullOrEmpty(s))
            {
                if (_wrapper == null)
                {
                    _customParticle = Pool.LoadGo(s);
                    _wrapper = new GoWrapper(_customParticle);
        ...
        {
            base.Dispose();
            if (_customParticle != null)
            {
                Pool.UnLoad(_customParticle);
            }
        }

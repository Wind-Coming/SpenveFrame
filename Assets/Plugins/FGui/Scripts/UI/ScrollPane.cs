...
namespace FairyGUI
{
    ...
    public class ScrollPane : EventDispatcher
    {
        ...
        public float containerPosY => _container.y;
        public float containerPosX => _container.x;
        ...
        public void SetContainerPosY(float y)
        {
            _container.y = y;
        }
        
        public void SetContainerPosX(float x)
        {
            _container.x = x;
        }
